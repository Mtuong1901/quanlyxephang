        ...
        <>
            <div className="capso mt-[100px] ">
                ...
                <div className="flex gap-[24px] items-center">
                    ...
                    <div className="tendichvu w-[154px] h-[72px] flex flex-col gap-1 mt-[16px]">
                    ...
                    <div className="tinhtrang w-[154px] h-[72px] flex flex-col gap-1 mt-[16px]">
                    ...
                    {/* Dropdown Nguồn Cấp */}
                    <div className="nguoncap w-[154px] h-[72px] flex flex-col gap-1 mt-[16px]">
