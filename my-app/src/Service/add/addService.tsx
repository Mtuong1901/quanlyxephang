                        ...
                        <div className="flex ml-[24px] gap-[24px]">
                            <div className="flex w flex-col gap-[12px]">
                                <div className="w-[553px] h-[76px]">
                                    ...
                                    <input type="text" className="w-full h-[44px] border-[2px] rounded-lg" />
                                </div>
                                <div className="w-[553px] h-[76px]">
                            ...
                            <div className="w-[553px] h-[164px] flex flex-col">
                                <label htmlFor="">Tên dịch vụ: <span className="text-[#FF4747]">*</span></label>
                                <textarea className=" appearance-none  resize-none w-full h-[132px] p-1 border-[1px] border-[#D4D4D7] rounded-lg p-2 " name="mota" id="mota" placeholder="Mô tả dịch vụ"></textarea>
                            </div>
                        </div>
