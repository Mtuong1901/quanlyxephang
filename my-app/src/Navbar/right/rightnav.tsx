                ...
                {/* device */}
                            <div className='device flex items-center border-1 bg-white mt-[14px] w-[353px] h-[83px] ml-[24px] rounded-lg shadow-2xl p-1'>
                                ...
                                <div className='flex flex-col ml-[12px]' >
                                    <p className='number text-[#535261] font-bold text-[24px]'>{devices.length}</p>
                                ...
                                <div className='ml-[37px] mt-2'>
                                    <ul className='mb-[5px] flex items-center gap-2 '>
                                        <li className='font-[400] text-[12px]  mb-2 list-disc text-[#FFD130]'><span className='text-[#7E7D88]'>Đang hoạt động </span></li><p className='text-[14px] text-[#FF7506] mb-2 p-0 font-bold'>{devices.filter(num => num.status === "Hoạt động").length}</p>
                                    </ul>
                                    <ul className='mb-[5px] flex  items-center gap-2 list-disc'>
                                        <li className='font-[400] text-[12px]  text-[#7E7D88] mb-2'><span className='text-[#7E7D88]'>Ngưng hoạt động</span></li><p className='text-[14px] text-[#FF7506] mb-2 p-0 font-bold' >{devices.filter(num => num.status === "Ngưng hoạt động").length}</p>
                                    </ul>
                                    <div>
                            ...
                            <div className='service flex items-center border-1 bg-white mt-[14px] w-[353px] h-[83px] ml-[24px] rounded-lg shadow-2xl p-1'>
                                ...
                                <div className='flex flex-col ml-[12px]' >
                                    <p className='number text-[#535261] font-bold text-[24px]'>{services.length}</p>
                                    <div className='flex flex-grow-0 items-center gap-1'>
                                ...
                                <div className='ml-[37px] mt-2 '>
                                    <ul className='mb-[5px] flex items-center gap-2'>
                                        <li className='font-[400] text-[12px] text-[#4277FF] mb-2 list-disc'><span className='text-[#7E7D88]'>Đang hoạt động</span> </li><p className='text-[14px] text-[#4277FF] mb-2 p-0 font-bold'>{services.filter(ser => ser.status === "Hoạt động").length}</p>
                                    </ul>
                                    <ul className='mb-[5px] flex  items-center gap-2 '>
                                        <li className='font-[400] text-[12px]  text-[#7E7D88] mb-2 list-disc'>Ngưng hoạt động</li><p className='text-[14px] text-[#4277FF] mb-2 p-0 font-bold' >{services.filter(ser => ser.status === "Ngưng hoạt động").length}</p>
                                    </ul>
                                    <div>
                                    </div>
                                </div>
                            ...
                            <div className='service flex items-center border-1 bg-white mt-[14px] w-[353px] h-[83px] ml-[24px] rounded-lg shadow-2xl p-1'>
                                <img className='w-[60px] h-[60px] ml-[16px] mr-[12px] mt-0 mb-0' src="./images/tron2.png" alt="service" />
                                <div className='flex flex-col ml-[12px]' >
                                    <p className='number text-[#535261] font-bold text-[24px]'>{numbers.length}</p>
                                    <div className='flex flex-grow-0 items-center gap-1'>
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='ml-[37px] mt-2'>
                                    <ul className=' flex items-center gap-2'>
                                        <li className='font-[400] text-[12px] text-[#35C75A]   mb-1 list-disc'><span className='text-[#7E7D88]'>Đang hoạt động </span></li><p className='text-[14px] text-[#35C75A] mb-1 p-0 font-bold'>{numbers.filter((num) => num.status === 'Đang chờ').length}</p>
                                    </ul>
                                    <ul className=' flex  items-center gap-2'>
                                        <li className='font-[400] text-[12px]  text-[#7E7D88] mb-1 list-disc'>Ngưng hoạt động</li><p className='text-[14px] text-[#35C75A] mb-1 p-0 font-bold' >{numbers.filter((num) => num.status === 'Đã sử dụng').length}</p>
                                    </ul>
                                    <ul className=' flex  items-center gap-2'>
                                        <li className='font-[400] text-[12px] text-[#F178B6] mb-1 list-disc'><span className='text-[#7E7D88]'>Bỏ qua</span></li><p className='text-[14px] text-[#35C75A] mb-1 p-0 font-bold' >{numbers.filter((num) => num.status === 'Bỏ qua').length}</p>
                                    </ul>
                                    <div>
                                    </div>
                                </div>
